...
| First / discharge month | VERIFIED_CONTEXTUAL_EXECUTION           | 제41조⑤ supplies the structure; 공무원보수규정 제4조제6호 fixes the denominator as the calendar days in the month; official MMA/2026 implementation guidance says the calculation includes holidays. The final KRW amount is calculated only when an explicitly supported payer rounding policy is confirmed; otherwise it stays GATED.                                                                                                                                                                                             |
| Non-payable days        | VERIFIED_CONTEXTUAL_EXECUTION           | 제41조⑥ lists the categories, and official MMA guidance pairs non-payable days with the same calendar-day daily-pay concept. Exact dated non-payable days plus an explicitly supported rounding policy unlock the calculation; a legacy yes/no flag alone never creates a deduction.                                                                                                                                                                                                                                                |
